                ...
                <div class="col-lg-12 col-md-12 sema-card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12" style="margin-left:120px; ">
                            <b>
                                <table style="font-size: 19px">
                                    <tr><td><b>Name </b></td><td><b>: {{$f->name ?? ''}}</b></td></tr>
                                    <tr><td><b>CPR No.</b></td><td>: {{$f->cpr_no ?? ''}}</td></tr>
                                    <tr><td><b>ID No. </b></td><td>: SHC222 - {{$f->id ?? ''}}</td></tr>
                                    <tr><td><b>Valid till </b></td><td>: {{$f->expiry ?? ''}}</td></tr>
                                </table>
                            </b>
