					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown nav-item main-header-message ">
								<a class="new nav-link " href="#"><svg xmlns="http://www.w3.org/2000/svg" class="header-icon-svgs" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg><span id="notifications_count2"  class="badge badge-purple side-badge">{{ auth()->user()->unreadNotifications->count() }}</span></a>
									...
									<div class="main-message-list chat-scroll" id="unreadNotifications">
                                        ...
                                        <a href="{{route('profile_show',$notification->data['id'])}}" class="p-3 d-flex border-bottom">
											...
											<div class="wd-90p">
												...
												<p class="mb-0 desc">{{ $notification->data['title'] }}</p>
							...
							<div class="dropdown nav-item main-header-notification">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										...
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">You have unread Notifications</p>
									</div>
									<div class="main-notification-list Notification-scroll">

                                        <a class="d-flex p-3 border-bottom" href="#">
											<div class="notifyimg bg-primary">
												<i class="la la-id-card text-white"></i>
											</div>
											<div class="mr-3">
									...
									<div class="main-header-profile bg-purple p-3">
										<div class="d-flex wd-100p">
											...
											<div class="mr-3 my-auto">
												<h6>{{\Illuminate\Support\Facades\Auth::user()->name}}</h6><span></span>
											</div>
										</div>
									</div>
