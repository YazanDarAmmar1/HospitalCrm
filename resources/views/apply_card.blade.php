                        ...
                        <div class="ttm-service-single-content-area">
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <input class="form-control" type="text" name="name[]" placeholder="Name" style="border:solid 2px #761193;border-radius: 20px; " required>
                                </div>
                                <div class="col-lg-6 mb-4">
                                    <label class="label tx-bold text-dark">CPR No. :</label>
                                    <input class="form-control" type="number" name="cpr[]" placeholder="CPR" style="border:solid 2px #761193;border-radius: 20px; " required>
                                </div>
                                <div class="col-lg-6 mb-4">
                                ...
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <select style="border:solid 2px #761193;border-radius: 20px; " class="form-control" name="package">
                                        <option label="select one"></option>
                                ...
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <input style="border:solid 2px #761193;border-radius: 20px; " class="form-control" type="text" name="phone[]" placeholder="Phone" >
                                </div>
                                <div class="col-lg-12 mb-4">
                                    <label class="label tx-bold text-dark">Email :</label>
                                    <input style="border:solid 2px #761193;border-radius: 20px; " class="form-control" type="email" name="email[]" placeholder="Email">
                                </div>

                                <div class="col-lg-3 mb-4">
                                    <label class="label tx-bold text-dark">House :</label>
                                    <input style="border:solid 2px #761193;border-radius: 20px; " class="form-control" type="text" name="house" placeholder="House" >
                                </div>
                                <div class="col-lg-3 mb-4">
                                    <label class="label tx-bold text-dark">Road :</label>
                                    <input style="border:solid 2px #761193;border-radius: 20px; " class="form-control" type="text" name="road" placeholder="Road" >
                                </div>
                                <div class="col-lg-3 mb-4">
                                    <label class="label tx-bold text-dark">Block :</label>
                                    <input style="border:solid 2px #761193;border-radius: 20px; " class="form-control" type="text" name="block" placeholder="Block" >
                                </div>
                                <div class="col-lg-3 mb-4">
                                    <label class="label tx-bold text-dark">Place :</label>
                                    <input style="border:solid 2px #761193;border-radius: 20px; " class="form-control" type="text" name="place" placeholder="Place" >
                                </div>

                                <div class="col-lg-6 mb-4">
                                    <label class="label tx-bold text-dark">Type Of Payment :</label>
                                    <select style="border:solid 2px #761193;border-radius: 20px; " class="form-control" name="type">
                                        <option label="select one"></option>
                                ...
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <input style="border:solid 2px #761193;border-radius: 20px; " class="form-control" type="file" name="img" >
                                </div>

                                <div class="col-lg-12 mb-5" id="survey_options">
                                    <label class="label tx-bold text-dark">Note :</label>
                                    <textarea style="border:solid 2px #761193;border-radius: 20px; " class="form-control" row="3" col="30" name="note"></textarea>
                                </div>
